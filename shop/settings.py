...
SECRET_KEY = 'django-insecure-!8^_a1librl&_r+-+9(0=4-t&x!f5eok(1farr9=-swyc&03jz'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'order_app.context_processors.cart_processor',
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    'account_app.backends.EmailOrPhoneBackend',
